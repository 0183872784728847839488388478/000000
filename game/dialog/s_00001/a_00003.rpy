label data_dialog_00001_00003:
    ...
    data_chr_00005_00000_00000 "Oh wow it got oblibrated"
    ...
    data_chr_00005_00008_00000 "<It Can't Be Helped>"

    data_chr_00005_00008_00000 "<It Seems Like You Have Friends Here>"
    ...
    data_chr_00005_00004_00000 "<Now What?...>"

    data_chr_00005_00007_00000 "<I Dont Know But What If We Start Walking>"
    ...
    data_chr_00005_00007_00000 "<Are we just going circle for the passed minute?>"

    data_chr_00005_00001_00000 "<its seems so>"

    data_chr "era yhet soronM?"

    data_chr_00005_00001_00000 "<Whos That? Hello?>"

    data_chr "~Fufu"

    #Miku Fufu Sound

    data_chr_00005_00005_00000 "<Elle Am Scared>"

    data_chr_00005_00008_00000 "<Who Are You? Come Out Come Out Whoever You Are>"

    $ renpy.notify('POV: Auriel\'s Pov')

    data_chr_00005_00000_00000 "Are they Morons?"

    data_chr "<sohws taht? olleh?>"

    data_chr_00005_00000_00000 "{i}what are they speaking?{/i}"

    data_ep_0 "Auriel murmur to herself"

    data_ep_0 "to her they are speaking nonsense"

    data_chr_00005_00000_00000 "{i}oh wait im gonna be late, i need to go{/i}"
    ...
    data_chr_00005_00007_00000 "<what is it?>"
    ...
    data_chr_00005_00000_00000 "Oh They Literally See Me"

    data_chr_00005_00000_00000 "I Should Go Instead Home"

    data_ep_0 ""

    data_chr_00005_00007_00000 "<Wait Who Are You>"
    ...
    data_chr_00005_00003_00000 "<Good Grief She Is So Fast>"

    data_chr_00005_00005_00000 "<My Legs Hurt>"

    data_chr_00005_00008_00000 "<Whats that house on the mountain>"

    data_chr_00005_00004_00000 "<I dont know maybe someone living there>"

    data_chr_00005_00001_00000 "<we are currently in emergency so i think its fine>"

    data_chr_00005_00003_00000 "<let see>"

    $ renpy.notify('POV: Auriel\'s Pov')

    data_chr_00005_00000_00000 "They saw me"

    data_chr_00005_00000_00000 "Im gonna be absent for today"

    data_ep_0 "she rest on a tree to take a break"

    data_chr_00005_00000_00000 "they might see me and follow me and cause chaos"

    data_ep_0 "she remembered something"

    data_chr_00005_00000_00000 "wait i forgeten about that spell....thats annoying "

    data_ep_0 "annoyed she casts a spell on herself "

    data_ep_0 "\[Refresh\] Shes Ready To Run Again"

    data_chr_00005_00000_00000 "Time To Go Home"

    $ renpy.notify('Going Back To The Group')

    $ renpy.notify('???\'s Mansion')

    data_chr_00005_00008_00000 "<Wow this is big>"

    data_chr_00005_00001_00000 "<Yeah, Oh the lights is on someone maybe inside>"

    data_chr_00005_00001_00000 "<lets knock>"

    #Knocking Door

    data_chr_00005_00007_00001 "<This Might Be A Bad Idea>"
